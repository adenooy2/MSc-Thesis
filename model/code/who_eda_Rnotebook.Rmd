...
Given the format of the model, it is useful to summarise the number of individuals reaching key points in the patient pathway. An initial analysis is conducted only for those people with TB. Based on descriptions of the model, key variables representing some some of these points are:


```{r}
#Filter to only those with TB
b_data_tb=b_data %>% filter(tb_present==1)
