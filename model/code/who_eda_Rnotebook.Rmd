...
The second data set consists of TB burden estimates for Kenya produced by the World Heath Organization (WHO) as well as the accompanying data dictionary. The estimates cover a range of data variables and their estimated values between the years 2000 and 2022. Several key variables include estimates on TB incidence (new cases), notifications (diagnoses) and deaths. Estimates are also provided for different groups of individuals (for example HIV postive patients) and for different tpes of TB.
...
#Conduct additional caluclations for rates or use rates to estimate numbers
